...
action="/admin/agents/update.php" is so that the data on the form is send to this webpage and not another, so it can't be edited by someone
...
<main class="container section">
    ...
    <form class="form" method="POST">
        ...
        <input type="submit" value="Update Agent" class="button green-button">
    </form>  
</main>
